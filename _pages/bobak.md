...
<!-- Dr. Mortazavi’s research in personalized digital health has led to significant accomplishments in research, service, and teaching, particularly through graduate advisement. His work focuses on systems and analytics for personalized health, emphasizing machine learning methods that enhance clinical outcomes through multimodal modeling and dynamic risk prediction. He has pioneered the integration of machine learning and embedded systems with clinical outcomes research, including the first models for cuffless blood pressure and automated diet estimation from continuous glucose monitors.
